...
<li>
      <table>
        <tr class="menu-close-tr">
          <td width="165px"><h2 style="color:#FFF;">更多</h2></td>
          <td width="50px"><img src="pic/close.png" class="menu-close"></td>
        </tr>
      </table>
    </li>
    <li class="menu-opt"><a href="index.html">首页</a></li>
    <li class="menu-opt"><a href="result.html">手动计算</a></li>
